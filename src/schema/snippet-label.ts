...
export const SnippetLabelModel = sqliteTable('snippet_label_tab', {
    snippetId: integer('snippet_id').notNull().references(() => SnippetModel.id),
    labelId: integer('label_id').notNull().references(() => LabelModel.id),
}, (t) => ({
